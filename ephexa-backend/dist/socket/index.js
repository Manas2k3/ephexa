...
function setupSocketHandlers(io) {
    ...
    io.on('connection', async (socket) => {
        ...
        socket.on('find_call', ({ interest }) => {
            ...
            console.log(`[find_call] Queue size before: ${callService_1.callService.getQueueSize()}`);
            ...
            if (callService_1.callService.isInQueue(socket.id)) {
            ...
            console.log(`[find_call] Added to queue. Queue size after: ${callService_1.callService.getQueueSize()}`);
